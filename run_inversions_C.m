...
lambda_Tk0 = 0.4199;
tic;
[x_Tk0,D_Tk0,L_Tk0,Gpo_Tk0] = invert.tikhonov(Lb*A,Lb*b,n_x(1),lambda_Tk0,0,sparse(x0));
t.Tk0 = toc;
...
lambda_Tk1 = 1.0690;
tic;
[x_Tk1,D_Tk1,L_Tk1,Gpo_Tk1] = invert.tikhonov(Lb*A,Lb*b,n_x(1),lambda_Tk1,1,sparse(x0));
t.Tk1 = toc;
disp('Inversion complete.');
disp(' ');
