...
- **STEP 2**: One must now generate a model matrix, `A`, which relates the distribution,
...
- One must also define some set of data in an appropriate format. For
...
the data may first be imported prior to the first part of Step 2.
