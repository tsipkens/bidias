...
function [Lambda,G0] = tfer_CPMA_F_diff(m_star,m,d,z,prop,varargin)
% TFER_CPMA_F_DIFF Evaluates the transfer function for a CPMA in Case F (w/ diffusion).
...
[~,G0] = kernel.tfer_CPMA_F(m_star,m,d,z,prop,varargin{:});
