...
tic;
[x_tk0,lambda_tk0,out_tk0] = optimize_a.tikhonov_op(Lb*A,Lb*b,grid_x,...
...
tic;
[x_tk1,lambda_tk1,out_tk1] = optimize_a.tikhonov_op(Lb*A,Lb*b,grid_x,...
...
tic;
[x_tk2,lambda_tk2,out_tk2] = optimize_a.tikhonov_op(Lb*A,Lb*b,grid_x,...
...
[x_mart,iter_mart,out_mart] = ...
    optimize_a.mart_op(A,b,x_init,1:300,x0);
t.MART = toc;
disp('Inversion complete.');
disp(' ');
...
[x_two,iter_two,out_two] = ...
    optimize_a.twomey_op(A,b,x_init,1:500,x0);
t.two = toc;
...
[x_two_mh,Sf_two_mh,out_two_mh] = ...
    optimize_a.twomark_op(A,b,Lb,grid_x,...
