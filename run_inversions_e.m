...
disp('Inversion complete.');
disp(' ');
chi.tk0_lcurve = 100*norm(x0-x_tk0_lc)/norm(x0);
...
disp('Inversion complete.');
disp(' ');
chi.tk1_lcurve = 100*norm(x0-x_tk1_lc)/norm(x0);
...
disp('Inversion complete.');
disp(' ');
chi.tk2_lc = 100*norm(x0-x_tk2_lc)/norm(x0);
...
chi.mart_mh = 100*norm(x0-x_mart_mh)/norm(x0);
