...
function [Lambda,G0] = tfer_CPMA_D_diff(m_star,m,d,z,prop,varargin)
% TFER_CPMA_D_DIFF Evaluates the transfer function for a CPMA in Case D.
...
[~,G0] = kernel_CPMA.tfer_CPMA_D(m_star,m,d,z,prop,varargin{:});
...
K22 = K_fun(real(G0(prop.r2)),prop.r2);
K21 = K_fun(real(G0(prop.r2)),prop.r1);
K12 = K_fun(real(G0(prop.r1)),prop.r2);
K11 = K_fun(real(G0(prop.r1)),prop.r1);
