...
function [Lambda,G0] = tfer_CPMA_A_diff(m_star,m,d,z,prop,varargin)
% TFER_CPMA_A_DIFF Evaluates the transfer function for a CPMA in Case A.
...
[~,G0] = kernel_CPMA.tfer_CPMA_A(m_star,m,d,z,prop,varargin{:});
