...
% MAIN_JAS20A_PLUS  Script associated with Sipkens et al., J. Aerosol Sci. (2020a).
% Executes and compares deterministic inversions schemes.
% Relative to main_jas20a, this script adds Bayesian methods (for accuracy/timing)
...
prop_p = prop_pma();  % get default CPMA properties

% Generate A matrix based on grid for x_t (fine resolution) and b.
A_t = kernel.gen_pma_dma_grid(grid_b, grid_t, prop_p, [], 'Rm', 3);
